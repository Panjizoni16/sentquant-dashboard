...
const SentquantLogo = ({ size = 120 }) => (
  ...
  >
    <path fill="#FFFFFF" d="M490 333.1c-60.3 7.7-116.7 49.2-142.8 104.9-5.7 12.2-11.3 29.4-14.3 44-2.2 10.3-2.4 14-2.3 35.5 0 13.2.5 25 1 26.3.9 2.1 1.8 1.3 13.9-12.5 7.2-8.1 19.1-21.5 26.5-29.8 7.5-8.2 27.6-31 44.6-50.5 17.1-19.5 38-43.2 46.5-52.6s25.1-27.7 36.9-40.8 21.7-24.2 21.8-24.7c.4-1.1-22.9-1-31.8.2"/>
    <path fill="#FFFFFF" d="M540.8 334.9c-.3.9-22.7 26.6-28.7 33.1-5.7 6.1-22.1 24.8-22.1 25.2 0 .3 2.4.1 5.3-.4 8.1-1.4 31.4-1.4 39.7.1 54.3 9.5 96.5 52.3 103.6 105.1 1.8 13.6 1.8 21.8-.2 34.9-3.5 24.3-15.6 50.7-31.2 68.1l-4.8 5.3-6.2-6.8-6.3-6.9-36.2.3c-19.9.1-36.3.3-36.4.4 0 .1 24.9 25.5 55.5 56.5l55.7 56.3 35.9-.1h35.9l-4.3-4.7c-3.8-4.2-11.2-11.9-44.3-46l-8-8.1 8.4-9.4c22.9-25.7 39.1-59.3 45-93.3 2.8-16.3 3-40.6.5-56.5-11.9-75.6-68.5-135.1-144.6-152.1-9.7-2.1-11.7-2.3-12.2-1"/>
    <path fill="#FFFFFF" d="M385 511.5c-2.5 2.9-12.8 14.5-23 25.9-10.2 11.5-20 22.6-21.9 24.8l-3.3 3.9 3.2 9.2c9.5 27.6 24.6 51.3 46.1 72.3 39.2 38.2 90.2 56.8 144.1 52.6 19.7-1.6 42.2-6.3 54.9-11.5l3.1-1.2-23.3-23.9-23.4-23.8-6.5 1.3c-9.1 1.7-30.7 1.5-40.5-.5-27.7-5.7-48.1-16.3-66.5-34.6-25.2-24.9-36.2-50-37.9-86.5l-.6-13.1z"/>
    <path fill="#FFFFFF" d="M967.7 946.2c-.2.7-.5 1.7-.5 2.2s-.4 1.2-.9 1.5-1.9 2.3-3.2 4.4-2.8 4.3-3.5 5c-.7.6-1.5 2-1.9 3s-1.1 1.6-1.6 1.3c-1.5-1-4.1.5-4.1 2.3 0 1.2-.2 1.3-.9.3-.6-1-1-1-2 .2-.7.8-2 1.2-2.9.9-1.3-.5-1.4-.3-.6.6.6.7 1.8 1.3 2.5 1.5 2 .3 9.1 5 11.3 7.5 1.3 1.5 2.3 1.8 3.1 1.1.9-.8 1.1-.4.8 1.3-.3 1.3.1 3 .9 3.8.7.8 1.4 2.1 1.6 2.9.5 2.1 1.6 3 2.7 2.2 1.9-1.4 4.6-7.2 3.9-8.5-.4-.6-.4-.9 0-.5 1.4 1.2 4.9-2.9 4.2-4.8-.5-1.3-.3-1.4.6-.6 1 .8 2.7.2 6.5-2.1 5.3-3.2 6.5-4.7 3.9-4.7-.8 0-2.1-.6-2.8-1.3-3.5-3.3-8.6-6.5-9.3-5.9-.5.4-.5.2-.1-.5.9-1.7-1.4-2.8-2.5-1.2-.7 1-.8.5-.5-1.3.3-1.7-.1-3.4-1-4.3-.8-.8-1.5-1.7-1.4-2 .1-2.1-.1-2.5-1.1-1.9-.8.4-.9 0-.4-1.5.7-2.2.1-3-.8-.9m.6 5.3c-.3.9-.8 1.4-1 1.1-.3-.3-.2-.9.2-1.5.9-1.6 1.5-1.3.8.4m-4.6 7.7c-.3.8-.6.5-.6-.6-.1-1.1.2-1.7.5-1.3.3.3.4 1.2.1 1.9m-3.6 16.5c1.3 1.6 1.2 1.7-.3.4-1.7-1.3-2.2-2.1-1.4-2.1.2 0 1 .8 1.7 1.7"/>
  </svg>
);

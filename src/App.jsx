              ...
              <>
                <div className="mb-10 animate-fade-in-up">
                  ...
                  <div className="flex flex-col space-y-2">
                      <div className="h-[300px] md:h-[400px] rounded-t-xl bg-[#030303] backdrop-blur-sm overflow-hidden relative">
                        <ResponsiveContainer width="100%" height="100%">
                      ...
                      <div className="h-[180px] rounded-b-xl bg-[#030303] backdrop-blur-sm overflow-hidden relative">
                        <ResponsiveContainer width="100%" height="100%">

...
// --- LOGO DATA (REUSED FOR COMPONENT & FAVICON) ---
const LOGO_PATHS = [
...
export default function App() {
  ...
  useEffect(() => {
    // SVG String constructed from the same paths used in SentquantLogo
    const svgString = `
